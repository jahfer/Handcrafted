...
public class ModRecipeProvider extends RecipeProvider {
        ...
        private void shaped(RegistryEntry<Item> result, int count, Supplier<Item> mainItem,
                        Function<ShapedRecipeBuilder, ShapedRecipeBuilder> builder) {
        ...
        private void shaped(RegistryEntry<Item> result, int count, TagKey<Item> mainItem,
                        Function<ShapedRecipeBuilder, ShapedRecipeBuilder> builder) {
                builder.apply(ShapedRecipeBuilder.shaped(RecipeCategory.MISC, result.get(), count)
                                .define('#', mainItem)
        ...
        private void shapeless(RegistryEntry<Item> result, int count, Supplier<Item> mainItem,
                        Function<ShapelessRecipeBuilder, ShapelessRecipeBuilder> builder) {
        ...
        private void woodSet(ResourcefulRegistry<Item> registry, int count,
                        Function<ShapedRecipeBuilder, ShapedRecipeBuilder> builder) {
        ...
        private void woodWithSlabSet(ResourcefulRegistry<Item> registry, int count,
                        Function<ShapedRecipeBuilder, ShapedRecipeBuilder> builder) {
                registry.stream().forEach(result -> {
                        Item wood = getPlanks(result);
        ...
        private void coloredSet(ResourcefulRegistry<Item> registry, int count,
                        Function<ShapedRecipeBuilder, ShapedRecipeBuilder> builder) {
                registry.stream().forEach(result -> {
        ...
        private void trim(ResourcefulRegistry<Item> registry, int count,
                        Function<ShapedRecipeBuilder, ShapedRecipeBuilder> builder) {
                registry.stream().forEach(result -> {
                        Item material = ModItemTagProvider.TRIM_MATERIALS.stream()
                                        .filter(i -> Objects.requireNonNull(BuiltInRegistries.ITEM.getKey(i)).getPath()
                                                        .split("_")[0]
                                                        .equals(result.getId().getPath().split("_")[0]))
        ...
        private void colorReplace(RegistryEntry<Item> result, TagKey<Item> mainItem, Supplier<Item> otherItem) {
                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, result.get(), 1)
                                ...
                                .unlockedBy("has_" + result.getId().getPath(), has(mainItem))
                                .save(output, BuiltInRegistries.ITEM.getKey(result.get()).getPath() + "_from_"
                                                + BuiltInRegistries.ITEM.getKey(otherItem.get()).getPath());
        }
        ...
        private Item getPlanks(RegistryEntry<Item> result) {
                ...
                return BuiltInRegistries.ITEM
                                .getOptional(ResourceLocation.withDefaultNamespace(
                                                result.getId().getPath().split("_")[0] + "_planks"))
                                .orElseThrow(() -> new IllegalArgumentException(
                                                "Planks not found for: " + result.getId()));
        }
        ...
        private Item getSlab(RegistryEntry<Item> result) {
                ...
                return BuiltInRegistries.ITEM
                                .getOptional(ResourceLocation
                                                .withDefaultNamespace(result.getId().getPath().split("_")[0] + "_slab"))
                                .orElseThrow(() -> new IllegalArgumentException(
                                                "Slab not found for: " + result.getId()));
        }
        ...
        private Item getWool(RegistryEntry<Item> result) {
                ...
                return BuiltInRegistries.ITEM
                                .getOptional(ResourceLocation
                                                .withDefaultNamespace(result.getId().getPath().split("_")[0] + "_wool"))
                                .orElseThrow(() -> new IllegalArgumentException(
